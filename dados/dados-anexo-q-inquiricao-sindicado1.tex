...
% ------------------------------------------------------------
\dataDocumento{11}{maio}{2026}{CIDADE/UF}
\chaveCronologica{20260511}

\novaInquiricaoSindicado
...
\inquiricaoHorarioMinutos{690}{710}
\inquiricaoPausaMinutos{0}
\quantidadeTestemunhasDenunciante{2}
\quantidadeTestemunhasSindicado{1}
\sindicadoMenor{nao}
\manifestacaoDefesaInquiricao{nada requereu além do já consignado}
